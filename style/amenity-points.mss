...
#text-point[zoom >= 10] {
  ...
  [feature = 'aeroway_aerodrome']['access' != 'private']['icao' != null]['iata' != null][zoom >= 10][zoom < 13] {
    [way_pixels <= 192000],
    [way_pixels = null] {
      text-name: "[iata]";
      text-size: @standard-font-size;
  ...
  [feature = 'aeroway_aerodrome']['access' != 'private']['icao' != null]['iata' != null][zoom >= 13][zoom < 17],
